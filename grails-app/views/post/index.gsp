...
<div id="list-post" class="content scaffold-list" role="main">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <g:sortableColumn property="itsAllowed"
                              title="${message(code: 'post.itsAllowed.label', default: 'Its Allowed')}"/>
        ...
        <g:each in="${postInstanceList}" status="i" var="postInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${postInstance.id}">${fieldValue(bean: postInstance, field: "topic")}</g:link></td>
