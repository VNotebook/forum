...
<body>
<a href="#show-forum" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <ol class="property-list forum">
        ...
        <g:if test="${forumInstance?.name}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${forumInstance}"
                                                                                        field="name"/></span>
        ...
        <g:if test="${forumInstance?.dateCreated}">
            <li class="fieldcontain">
                <span id="dateCreated-label" class="property-label"><g:message code="forum.dateCreated.label"
                                                                               default="Date Created"/></span>

                <span class="property-value" aria-labelledby="dateCreated-label"><g:formatDate
                        date="${forumInstance?.dateCreated}"/></span>
        ...
        <g:if test="${forumInstance?.category}">
            <li class="fieldcontain">
                <span id="category-label" class="property-label"><g:message code="forum.category.label"
                                                                            default="Category"/></span>

                <span class="property-value" aria-labelledby="category-label"><g:fieldValue bean="${forumInstance}"
                                                                                            field="category"/></span>
        ...
        <g:if test="${forumInstance?.admin}">
            <li class="fieldcontain">
                <span id="admin-label" class="property-label"><g:message code="forum.admin.label"
                                                                         default="Admin"/></span>

                <span class="property-value" aria-labelledby="admin-label"><g:link controller="admin" action="show"
                                                                                   id="${forumInstance?.admin?.id}">${forumInstance?.admin?.encodeAsHTML()}</g:link></span>
