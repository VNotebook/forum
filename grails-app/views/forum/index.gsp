...
<body>
<a href="#list-forum" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="dateCreated"
                              title="${message(code: 'forum.dateCreated.label', default: 'Date Created')}"/>

            <g:sortableColumn property="category"
                              title="${message(code: 'forum.category.label', default: 'Category')}"/>
        ...
        <g:each in="${forumInstanceList}" status="i" var="forumInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${forumInstance.id}">${fieldValue(bean: forumInstance, field: "name")}</g:link></td>
