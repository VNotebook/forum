...
<div id="show-user" class="content scaffold-show" role="main">
    ...
    <ol class="property-list user">
        ...
        <g:if test="${userInstance?.age}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="age-label"><g:fieldValue bean="${userInstance}"
                                                                                       field="age"/></span>
    ...
    <g:form url="[resource: userInstance, action: 'delete']" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit btn btn-default" action="edit" resource="${userInstance}"><g:message code="default.button.edit.label"
                                                                                     default="Edit"/></g:link>
