...
<body>
<a href="#show-file" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-file" class="content scaffold-show" role="main">
    ...
    <ol class="property-list file">
        ...
        <g:if test="${fileInstance?.fileType}">
            <li class="fieldcontain">
                <span id="fileType-label" class="property-label"><g:message code="file.fileType.label"
                                                                            default="File Type"/></span>

                <span class="property-value" aria-labelledby="fileType-label"><g:fieldValue bean="${fileInstance}"
                                                                                            field="fileType"/></span>
        ...
        <g:if test="${fileInstance?.size}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="size-label"><g:fieldValue bean="${fileInstance}"
                                                                                        field="size"/></span>
        ...
        <g:if test="${fileInstance?.content}">
            <li class="fieldcontain">
                <span id="content-label" class="property-label"><g:message code="file.content.label"
        ...
        <g:if test="${fileInstance?.post}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="post-label"><g:link controller="post" action="show"
                                                                                  id="${fileInstance?.post?.id}">${fileInstance?.post?.encodeAsHTML()}</g:link></span>
    ...
    <g:form url="[resource: fileInstance, action: 'delete']" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit btn btn-default" action="edit" resource="${fileInstance}"><g:message code="default.button.edit.label"
                                                                                     default="Edit"/></g:link>
